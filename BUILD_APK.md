...
このフォルダは [MedjedBuilder -メジェドビルダー-](https://github.com/Xenoah/html2apk) でそのまま APK 化できるプロジェクトです。
...
1. [リリースページ](https://github.com/Xenoah/html2apk/releases) から `MedjedBuilder-Windows-x64.zip` をダウンロード・展開し、`MedjedBuilder.exe` を起動する。
